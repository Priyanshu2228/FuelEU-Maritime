...
async function main() {
  const routes = [
    ...
    { routeId: 'R004', vesselType: 'RoRo', fuelType: 'HFO', year: 2024, ghgIntensity: 89.2, fuelConsumption: 4900, distance: 11800, totalEmissions: 4300 },
    { routeId: 'R005', vesselType: 'Container', fuelType: 'LNG', year: 2024, ghgIntensity: 90.5, fuelConsumption: 4950, distance: 11900, totalEmissions: 4400 },
  ];
